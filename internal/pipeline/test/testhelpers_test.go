...
func commitEnv() []string {
	return []string{
		"GIT_AUTHOR_NAME=test-stage-test",
		"GIT_AUTHOR_EMAIL=test-stage-test@example.com",
		"GIT_COMMITTER_NAME=test-stage-test",
		"GIT_COMMITTER_EMAIL=test-stage-test@example.com",
	}
}
...
func setupFixture(t *testing.T) fixture {
	...
	writeFile(t, srcPath, "README.md", "test-stage fixture\n")
	run(t, srcPath, "add", ".")
